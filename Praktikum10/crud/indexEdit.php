        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            <tr>
                ...
                <td>
                    ...
                    <a class="btn btn-danger" href="proses.php?aksi=hapus&id=<?= $row["id"] ?>" data-toggle="modal" data-target="#hapusModal<?= $row["id"] ?>">Hapus</a>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <a class="btn btn-danger" href="proses.php?aksihapus&id=<?= $row["id"] ?>">Hapus</a>
